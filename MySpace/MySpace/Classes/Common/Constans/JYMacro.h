...
//3.设置随机颜色
#define JYRandomColor [UIColor colorWithRed:arc4random_uniform(256)/255.0 green:arc4random_uniform(256)/255.0 blue:arc4random_uniform(256)/255.0 alpha:1.0]

//4.设置RGB颜色/设置RGBA颜色
// clear背景颜色
#define JYClearColor [UIColor clearColor]
...
//7.设置 view 圆角和边框
#define JYViewBorder(View, Radius, Width, Color)\
\
...
//8.由角度转换弧度 由弧度转换角度
#define JYDegreesToRadian(x) (M_PI * (x) / 180.0)
#define JYRadianToDegrees(radian) (radian*180.0)/(M_PI)

//9.设置加载提示框（第三方框架：Toast）
#define JYToast(str)              CSToastStyle *style = [[CSToastStyle alloc] initWithDefaultStyle]; \
...
// 图片只加载一次
#define ContentImageName(name) [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:name ofType:nil]]
